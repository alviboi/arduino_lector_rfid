...
void reset_disp() {
      ...
      escriu_rom("192.168.0.36",MYSQL_SERVER, 12);
      escriu_rom("root",MYSQL_USER, 4);
      escriu_rom("root",MYSQL_PASSWD, 4);
      escriu_rom("admin",PASSW_MEM, 5);
      escriu_rom("LACASANOSTRA",SSID_MEM, 12);
      escriu_rom("7356TomatesConfites",SSID_PASSWD_MEM, 19);
...
void setup() {
 ...
 //SERVIDOR DE PARÀMETRES  
  //Este es canviarà per un mé segur, un post o un get o amb un token en el GET
